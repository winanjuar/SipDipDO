...
- **Manajemen owner oleh COO**: identitas dan kontak (WA/email) dapat diedit dan tercatat audit; kontak email adalah kanal Bukti Transaksi & OTP MFA (kesiapan Epic 3). Perubahan status siklus hidup lewat edit langsung ditolak — hanya transisi sah bersistem compare-and-set + event domain.
